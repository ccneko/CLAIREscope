...
4. **🌋 Differential Expression & Volcano Studio**: Bidirectional Wilcoxon statistical testing, multi-token union gene search (`ITGB, LAM, COL`), top-layer SVG highlight rings, and spatially aligned DEG tables.
